...
class Perceptron:
	...
	def __init__(self, taxaAprendizagem=1e-3, qtdMaxEpocas=1000, armazenarEvolucaoNeuronios=True):
	...
	def __criarETreinarUnicoNeuronio(self, xTreinamento, yTreinamento, classeDesejada):
	    ...
	    objNeuronio.treinar(xTreinamento, yBinarioClasseAtual, armazenarEvolucao=True)
	    objNeuronio.treinar(xTreinamento, yBinarioClasseAtual, self.taxaAprendizagem, self.qtdMaxEpocas, self.armazenarEvolucaoNeuronios)
